...
class experiment_selector_widget(QtGui.QWidget):
    ...
    def setupLayout(self):
        ...
        layout.addWidget(self.refresh_button, 0, 1, 1, 1)
        layout.addWidget(self.dropdown, 0, 2, 1, 6)
        layout.addWidget(self.run_button, 1, 0, 1, 2)
        layout.addWidget(self.repeat_button, 1, 2, 1, 2)
        layout.addWidget(self.scan_button, 1, 4, 1, 2)
        layout.addWidget(self.schedule_button, 1, 6, 1, 2)
        self.setLayout(layout)
